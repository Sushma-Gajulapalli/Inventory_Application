...
////////////////////////////////////////////////////////////////
	...
	function _applyGSUBsubtable($lookupID, $subtable, $ptr, $currGlyph, $currGID, $subtable_offset, $Type, $Flag, $MarkFilteringSet, $LuCoverage, $currentTag, $is_old_spec, $tagInt, $level = 0)
	{
...
// the last of any Marks which immediately follow the current glyph
	...
	function _applyGPOSsubtable($lookupID, $subtable, $ptr, $currGlyph, $currGID, $subtable_offset, $Type, $Flag, $MarkFilteringSet, $LuCoverage, $tag, $is_old_spec, $level = 0)
	{
		if (($Flag & 0x0001) == 1) {
			$dir = 'RTL';
...
////////////////////////////////////////////////////////////////
	...
	function _bidiSort($ta, $dir, &$chunkOTLdata, $useGPOS, $str = '')
	{
